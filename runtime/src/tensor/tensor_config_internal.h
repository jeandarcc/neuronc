#ifndef Neuron_RUNTIME_TENSOR_CONFIG_INTERNAL_H
#define Neuron_RUNTIME_TENSOR_CONFIG_INTERNAL_H

#include <stdint.h>

typedef int TensorProfile;
#ifndef Neuron_RUNTIME_TENSOR_KERNEL_VARIANT_DEFINED
#define Neuron_RUNTIME_TENSOR_KERNEL_VARIANT_DEFINED
